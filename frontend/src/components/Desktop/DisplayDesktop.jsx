...
import DisplayHome from "./DisplayHomeDesktop";
import DisplayPlaylist from "./Playlist/DisplayPlaylist";
import { Route, Routes, useLocation } from "react-router-dom";
import { PlayerContext } from "../../contexts/PlayerContext";
import Search from "./SearchDesktop";
...
const Display = () => {
  ...
  return (
    <div
      ref={displayRef}
      className="scroll-container w-[100%] m-2 px-6 pt-4 rounded-lg bg-[#121212] text-white overflow-auto lg:w-[75%] lg:ml-0"
    >
      <Navbar />
