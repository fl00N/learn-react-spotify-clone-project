...
const LoginMessage = ({ isOpen, onClose }) => {
  ...
  return !authState.token ? (
    <div className="fixed left-[24rem] top-[12rem] flex items-center justify-center z-[1]">
      <div
        ref={messageRef}
        className="bg-[#0074e0] p-4 w-[22rem] rounded-lg shadow-2xl animate-slide-in"
      >
        ...
        <h2 className="font-[Metropolis] font-bold text-base mb-2">
          Create a playlist
        </h2>
        <p className="font-[Metropolis] font-medium text-[0.86rem] mb-4">
