...
const SideBar = () => {
  ...
  return (
    <div className="w-[25%] max-lg:pr-0 h-full p-2 flex-col gap-2 text-white flex overflow-hidden">
      <div className="bg-[#121212] h-[20%] rounded-lg flex flex-col justify-around">
        <div
          onClick={() => navigate("/")}
          className={`flex items-center gap-5 pl-6 cursor-pointer transition ${
            isHomeActive
              ? "brightness-200"
      ...
      <div className="bg-[#121212] h-[80%] rounded-lg">
        <div className="pt-4 pb-4 flex items-center justify-between">
          <div className="flex items-center gap-3 pl-6 brightness-65 hover:brightness-100 cursor-pointer transition">
            ...
            <p className="font-semibold max-lg:hidden">My Library</p>
          </div>
        ...
        <div className="h-[320px] overflow-auto lg:h-full">
          {playlistsData.length === 0 && (
            <div>
              <div className="p-4 bg-[#242424] m-2 rounded-lg font-semibold flex flex-col items-start justify-start gap-1 pl-4">
                <h1 className="font-[Metropolis] text-[#b3b3b3]">
                  Create your first playlist
                </h1>
                <p className="font-[Metropolis] text-[#b3b3b3] font-medium text-[14px]">
              ...
              <div className="p-4 bg-[#242424] m-2 rounded-lg font-semibold flex flex-col items-start justify-start gap-1 pl-4">
                ...
                <p className="font-[Metropolis] text-[#b3b3b3] font-medium text-[14px]">
                  We will keep you on new episodes
                </p>
                <button className="font-[Metropolis] font-bold px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4 hover:bg-gray-200 hover:scale-[1.03] active:bg-gray-400 active:scale-100">
                  Browse Podcasts
                </button>
              </div>
            </div>
